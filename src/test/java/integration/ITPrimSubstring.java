 ...
 * @author Aurelien
 */
public class ITPrimSubstring extends TestCase implements IntegrationTest {
    
    private final String qvtrFile = "C:\\Logiciels\\eclipse_workspace\\decomposition\\src\\test\\resources\\specs\\primSubstring\\primSubstring.qvtr";
    
    public ITPrimSubstring() {
        super("Integration Primitive (.substring())");
    }
