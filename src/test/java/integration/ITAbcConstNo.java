 ...
 * @author Aurelien
 */
public class ITAbcConstNo extends TestCase implements IntegrationTest {
    
    private final String qvtrFile = "C:\\Logiciels\\eclipse_workspace\\decomposition\\src\\test\\resources\\specs\\abcConstNo\\abcConstNo.qvtr";
    
    public ITAbcConstNo() {
        super("Integration ABC with constant A (IRREDUCIBLE)");
    }
