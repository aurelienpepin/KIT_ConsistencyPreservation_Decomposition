 ...
 * @author Aurelien
 */
public class ITAbcSequence extends TestCase implements IntegrationTest {
    
    private final String qvtrFile = "C:\\Logiciels\\eclipse_workspace\\decomposition\\src\\test\\resources\\specs\\abcSequence\\abcSequence.qvtr";
    
    public ITAbcSequence() {
        super("Integration ABC (with sequence literals as preconditions)");
    }
