 ...
 * @author Aurelien
 */
public class ITAbcNo extends TestCase implements IntegrationTest {
    
    private final String qvtrFile = "C:\\Logiciels\\eclipse_workspace\\decomposition\\src\\test\\resources\\specs\\abcNo\\abcNo.qvtr";
    
    public ITAbcNo() {
        super("Integration ABC (IRREDUCIBLE)");
    }
