 ...
 * @author Aurelien
 */
public class ITAbcPlus extends TestCase implements IntegrationTest {
    
    private final String qvtrFile = "C:\\Logiciels\\eclipse_workspace\\decomposition\\src\\test\\resources\\specs\\abcPlus\\abcPlus.qvtr";
    
    public ITAbcPlus() {
        super("Integration ABC (using + operation)");
    }
